                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1">
                                Today&apos;s focus is on understanding the fundamental concepts
                                of computer networks, including the OSI model, TCP/IP protocol
                                suite, and basic routing algorithms.
                            </p>
                        </div>
                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="space-y-3">
                                    {resources.map((resource, index) => (
                                        <div
                                            key={index}
                                            className={`flex items-center gap-3 border rounded-lg p-3 ${resource.completed ? "bg-primary/5" : ""
                                                }`}
                                        >
                                            ...
                                            <div className="flex-1">
                                                <p
                                                    className={`font-medium ${resource.completed ? "line-through opacity-70" : ""
                                                        }`}
                                                >
                                                    {resource.title}
                                                </p>
                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="space-y-6">
                                    {practices.map((practice, index) => (
                                        <Link
                                            href={`/${practice.type === "Quiz" ? "quiz" : "interview"
                                                }/${new Date().getTime()}`}
                                            key={index}
                                        >
                                            <div className="p-4 border hover:shadow-sm rounded-lg flex justify-between items-center">
                                                <div>
                                                    <h3
                                                        className={`font-medium ${practice.completed ? "opacity-70" : ""
                                                            }`}
                                                    >
                                                        {practice.title}
                                                    </h3>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span
                                                        className={`bg-${practice.typeColor}/10 text-${practice.typeColor} text-xs px-2 py-1 rounded`}
                                                    >
                                                        {practice.type}
                                                    </span>
                                                    <Button
                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="grid grid-cols-4 gap-3 mb-6">
                                    {[
                                        ...
                                        <div
                                            key={index}
                                            className={`${item.bg} ${item.text} rounded-lg p-3 text-center`}
                                        >
